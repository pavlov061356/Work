...
#include <memory>
#include "../WebSocket_Server/websocketserver.h"
...
QT_MOC_LITERAL(6, 65, 11), // "RecieveFile"
QT_MOC_LITERAL(7, 77, 18) // "SocketDisconnected"

    },
    "WebSocketServer\0closed\0\0NewConnection\0"
    "ProcessTextMessage\0message\0RecieveFile\0"
    "SocketDisconnected"
};
...
void WebSocketServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->RecieveFile((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
